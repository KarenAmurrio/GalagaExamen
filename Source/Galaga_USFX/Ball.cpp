...
ABall::ABall()
{
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInstance> MaterialBall(TEXT("MaterialInstanceConstant'/Game/Geometry/Meshes/CubeMaterial_Inst.CubeMaterial_Inst'"));
